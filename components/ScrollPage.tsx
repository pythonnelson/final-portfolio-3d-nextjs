...
export const DivContainer = forwardRef(({ children }, ref) => (
  <>
    ...
    <section className="flex items-center h-[100vh] relative text-lg pl-[10%] pr-[10%] text-[#ffeded] justify-end">
      <About />
    </section>
    ...
    <section className="flex items-center w-[100%] relative text-lg text-[#ffeded]">
      <Footer />
    </section>
  </>
));
